...
function Middle() {
  return (
    <div><div className="max-w-full px-6 py-16 mx-auto space-y-12 bg-zinc-950 flex justify-centerm flex justify-center">
	<article className="space-y-8 dark:bg-zinc-100 dark:text-gray-900 w-[50%]">
